VERSION 5.00
Begin VB.Form frmtimetablestd 
   Appearance      =   0  'Flat
   BackColor       =   &H80000005&
   Caption         =   "Timetable (Student)"
   ClientHeight    =   8295
   ClientLeft      =   120
   ClientTop       =   765
   ClientWidth     =   11280
   ...
   End
   Begin VB.Menu timetablestudent 
      Caption         =   "TIME TABLE"
   End
   Begin VB.Menu lououtstudent 
      Caption         =   "LOG OUT"
   End
End
Attribute VB_Name = "frmtimetablestd"
...
Private Sub Form_Load()
    studentID = frmstudentdetails.txtstdiddetails
    OpenTuitionDatabase
    OpenLearnTable
...
Private Sub lououtstudent_Click()
    frmindex.Show
    Unload frmtimetablestd
...
Private Sub timetablestudent_Click()
